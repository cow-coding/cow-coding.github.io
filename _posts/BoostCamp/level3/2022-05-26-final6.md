...
저희가 hit를 하는 기준은 **repository star**이므로 repository의 star user list를 가져와서 학습용 user군을 확보하기로 했습니다. 각 repository별로 최대 1000명씩 확보하기로 했고 최종적으로 약 120만명의 user군이 확보될 것으로 확인했습니다.
