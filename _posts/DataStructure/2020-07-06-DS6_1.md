...
<img src="/image/gtree.png" style="width: 450px;">  
...
- height of tree : height는 node와 tree 어디에 붙여서 설명하냐에따라 약간씩 달라진다. tree의 height라고 말하면 트리의 높이를 말한다. 일반적으로 해당 트리의 노드 중 가장 큰 depth 값을 tree의 height로 한다.  
