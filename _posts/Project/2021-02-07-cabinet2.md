...
date: 2021-02-07
project: true
categories: [Computer Science, Back End]
tags:
- project
- Node.js
- MongoDB
...
각 층의 레이아웃에 존재하는 사물함은 모두 버튼으로 구현했다. 해당 사물함 버튼을 클릭하면 신청 API로 넘어가게 된다.
...
<a href="https://cow-coding.github.io/computer%20science/back%20end/cabinet1/">[Cabinet Project] 사물함 배정 프로그램 개발일지 1
- 로그인 화면, API 개발</a><br>
