...
- 회귀분석 1
    ...
    3. 회귀계수 (regression coefficient)
...
- 잔차의 산점도 예제
    ...
    ```
    실행결과를 보면 아래와 같다.
    ![](/image/R/histft.png){: w="400"} 
    ![](/image/R/plotft.png){: w="400"} 
